...
class Converters {
    ...
    @TypeConverter
    fun fromCustomFields(value: List<CustomField>): String =
        gson.toJson(value)

    @TypeConverter
    fun toCustomFields(value: String): List<CustomField> {
        val type = object : TypeToken<List<CustomField>>() {}.type
        return gson.fromJson(value, type) ?: emptyList()
    }

    @TypeConverter
    fun fromChecklist(value: List<Boolean>): String =
        gson.toJson(value)

    @TypeConverter
    fun toChecklist(value: String): List<Boolean> {
